  ...
  var child4 = (function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el4 = dom.createTextNode(" 技术支持");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n                ");
  ...
  var child1 = (function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el0,"title","关闭");
        var el1 = dom.createElement("span");
        dom.setAttribute(el1,"class","hidden");
        var el2 = dom.createTextNode("关闭");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
  ...
  var child0 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        content(env, morph0, context, "role.description");
        return fragment;
      }
    };
  }());
...
define('ghost/templates/components/gh-uploader', ['exports'], function(__exports__){ __exports__['default'] = Ember.HTMLBars.template((function() {
  return {
    ...
    build: function build(dom) {
      ...
      var el2 = dom.createElement("span");
      dom.setAttribute(el2,"class","hidden");
      var el3 = dom.createTextNode("图片上传");
      dom.appendChild(el2, el3);
      dom.appendChild(el1, el2);
      var el2 = dom.createTextNode("\n");
      dom.appendChild(el1, el2);
...
define('ghost/templates/forgotten', ['exports'], function(__exports__){ __exports__['default'] = Ember.HTMLBars.template((function() {
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element1 = dom.childAt(element0, [3]);
      var morph0 = dom.createMorphAt(dom.childAt(element0, [1]),0,1);
      inline(env, morph0, context, "gh-trim-focus-input", [], {"value": get(env, context, "email"), "class": "email", "type": "email", "placeholder": "邮箱", "name": "email", "autofocus": "autofocus", "autocapitalize": "off", "autocorrect": "off"});
  ...
  var child0 = (function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el3 = dom.createTextNode("Markdown 官方文档");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("。\n    ");
        dom.appendChild(el1, el2);
    ...
    var child2 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph1 = dom.createMorphAt(dom.childAt(element2, [4]),2,3);
          var morph2 = dom.createMorphAt(element3,2,3);
          var morph3 = dom.createMorphAt(dom.childAt(element3, [4]),2,3);
    ...
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.setAttribute(el0,"title","新建博文");
          var el1 = dom.createTextNode("我来写一篇");
          dom.appendChild(el0, el1);
          return el0;
        },
        render: function render(context, env, contextualElement) {
...
define('ghost/templates/settings/about', ['exports'], function(__exports__){ __exports__['default'] = Ember.HTMLBars.template((function() {
  ...
  return {
    ...
    build: function build(dom) {
      ...
      dom.setAttribute(el5,"src","/ghost/img/ghostchina-logo.png");
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph6 = dom.createMorphAt(dom.childAt(element2, [19]),-1,-1);
      var morph7 = dom.createMorphAt(dom.childAt(element0, [3, 3]),0,1);
  ...
  var child2 = (function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("p");
        var el4 = dom.createTextNode("启用插入代码功能");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n                ");
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("p");
        var el3 = dom.createTextNode("此功能用于为主题页面插入代码（完善中）。");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n            ");
        dom.appendChild(el1, el2);
      ...
      var child0 = (function() {
        ...
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            var morph0 = dom.createMorphAt(dom.childAt(element1, [1]),-1,0);
            var morph1 = dom.createMorphAt(dom.childAt(element2, [1]),0,1);
...
define('ghost/templates/signin', ['exports'], function(__exports__){ __exports__['default'] = Ember.HTMLBars.template((function() {
  var child0 = (function() {
    return {
      ...
      hasRendered: false,
      build: function build(dom) {
        var el0 = dom.createTextNode("忘记密码？");
        return el0;
      },
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
